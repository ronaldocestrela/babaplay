...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260318233120_AddDailyCheckIn")]
            ...
            modelBuilder.Entity("Domain.Entities.Associado", b =>
                {
                    ...
                    b.ToTable("Associados", "Academics");
            ...
            modelBuilder.Entity("Domain.Entities.Association", b =>
                {
                    ...
                    b.ToTable("Associations", "Academics");

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("Domain.Entities.DailyCheckIn", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("AssociadoId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("AssociadoId", "Date")
                        .IsUnique();

                    b.ToTable("DailyCheckIns", "Academics");
