        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssociateId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CashEntries_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CheckIns_CheckInSessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssociatePositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssociatePositions_Associates_AssociateId",
                        column: x => x.AssociateId,
                        principalTable: "Associates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssociatePositions_Positions_PositionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssociatePositions_AssociateId_PositionId",
                table: "AssociatePositions",
                columns: new[] { "AssociateId", "PositionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AssociatePositions_PositionId",
                table: "AssociatePositions",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_CashEntries_CategoryId",
                table: "CashEntries",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CheckIns_AssociateId_CheckedInAt",
                table: "CheckIns",
                columns: new[] { "AssociateId", "CheckedInAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Memberships_AssociateId_Year_Month",
                table: "Memberships",
                columns: new[] { "AssociateId", "Year", "Month" },
                unique: true);
