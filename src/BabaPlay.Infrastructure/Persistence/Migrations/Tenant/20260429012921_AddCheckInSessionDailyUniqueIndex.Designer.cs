...
namespace BabaPlay.Infrastructure.Persistence.Migrations.Tenant
{
    ...
    [Migration("20260429012921_AddCheckInSessionDailyUniqueIndex")]
    partial class AddCheckInSessionDailyUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BabaPlay.Modules.CheckIns.Entities.CheckInSession", b =>
                {
                    ...
                    b.Property<DateTime?>("StartedAtDateUtc")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("date")
                        .HasComputedColumnSql("CAST([StartedAt] AS DATE)", true);
            ...
            modelBuilder.Entity("BabaPlay.Modules.MatchReports.Entities.MatchReport", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BabaPlay.Modules.MatchReports.Entities.MatchReportGame", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("MatchReportId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("MatchReportId", "GameNumber")
                        .IsUnique();

                    b.ToTable("MatchReportGames");
                });

            modelBuilder.Entity("BabaPlay.Modules.MatchReports.Entities.MatchReportPlayerStat", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("MatchReportGameId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("MatchReportGameId", "AssociateId")
                        .IsUnique();

                    b.ToTable("MatchReportPlayerStats");
                });
            ...
            modelBuilder.Entity("BabaPlay.Modules.MatchReports.Entities.MatchReportGame", b =>
                {
                    b.HasOne("BabaPlay.Modules.MatchReports.Entities.MatchReport", "MatchReport")
                        .WithMany("Games")
            ...
            modelBuilder.Entity("BabaPlay.Modules.MatchReports.Entities.MatchReportPlayerStat", b =>
                {
                    b.HasOne("BabaPlay.Modules.MatchReports.Entities.MatchReportGame", "MatchReportGame")
                        .WithMany("PlayerStats")
                        .HasForeignKey("MatchReportGameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MatchReportGame");
                });
