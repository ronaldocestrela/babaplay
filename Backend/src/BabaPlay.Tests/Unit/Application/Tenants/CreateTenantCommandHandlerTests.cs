...
public class CreateTenantCommandHandlerTests
{
    ...
    {
        _handler = new CreateTenantCommandHandler(_tenantRepo.Object, _queue.Object, _ownerProvisioning.Object);
    ...
    {
        // Act
        var result = await _handler.HandleAsync(new CreateTenantCommand("", "slug", "owner@test.com", "Password@123", null));
    ...
    {
        // Act
        var result = await _handler.HandleAsync(new CreateTenantCommand("My Club", "", "owner@test.com", "Password@123", null));
    ...
    public async Task Handle_DuplicateSlug_ShouldReturnTenantSlugTaken()
    {
        ...
        // Act
        var result = await _handler.HandleAsync(new CreateTenantCommand("My Club", "myclob", "owner@test.com", "Password@123", null));
    ...
    {
        // Act
        var result = await _handler.HandleAsync(new CreateTenantCommand("My Club", "myclob", null, null, null));
