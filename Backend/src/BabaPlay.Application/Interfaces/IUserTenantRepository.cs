...
public interface IUserTenantRepository
{
    ...
    /// <summary>Returns true when the user is owner/admin of the given tenant.</summary>
    Task<bool> IsOwnerAsync(string userId, Guid tenantId, CancellationToken ct = default);
