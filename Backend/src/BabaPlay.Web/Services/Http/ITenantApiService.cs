...
public interface ITenantApiService
{
    ...
    Task<(TenantSummaryDto? Result, string? ErrorMessage)> CreateTenantAsync(CreateTenantDto dto, IBrowserFile? logoFile, CancellationToken cancellationToken = default);
